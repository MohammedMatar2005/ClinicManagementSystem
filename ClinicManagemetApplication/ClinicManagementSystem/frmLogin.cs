...
namespace ClinicManagementSystem
{
   ...
   // 4. نجاح تسجيل الدخول
            ...
            {
                // إظهار رسالة الخطأ الأصلية بالإضافة للـ StackTrace ورقم السطر
                string fullErrorDetails = $"تفاصيل الخطأ:\n{ex.Message}\n\n" +
                                         $"مصدر الخطأ (Source):\n{ex.Source}\n\n" +
                                         $"تتبع السطر والملف (StackTrace):\n{ex.StackTrace}";

                MessageBox.Show(fullErrorDetails, "خطأ في النظام - تفاصيل تقنية",
                    MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1,
                    MessageBoxOptions.RightAlign | MessageBoxOptions.RtlReading);
            }
        }
