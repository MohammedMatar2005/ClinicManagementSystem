...
using ClinicBusinessLayer.Models; // تأكد من مطابقة مسار الموديلات والـ DbContext لديك
using ClinicBusinessLayer.DTO.PatientsDTOs;
using ClinicBusinessLayer.DTO.PatientVisitsDTOs;
using ClinicBusinessLayer.DTO.PaitentVisitsDTOs;
